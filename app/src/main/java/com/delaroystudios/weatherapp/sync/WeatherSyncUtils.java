 ...
 */
package com.delaroystudios.weatherapp.sync;
...
//  COMPLETED (10) Add constant values to sync Weather every 3 - 4 hours
    /*
...
//  COMPLETED (12) Create a method to schedule our periodic weather sync
    /**
     * Schedules a repeating sync of Weather's weather data using FirebaseJobDispatcher.
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        Job syncWeatherJob = dispatcher.newJobBuilder()
                ...
                /*
                 * We want Weather's weather data to stay up to date, so we tell this Job to recur.
                 */
                .setRecurring(true)
                /*
...
//      COMPLETED (13) Call the method you created to schedule a periodic weather sync
        /*
         * This method call triggers Weeather to create its task to synchronize weather data
         * periodically.
         */
