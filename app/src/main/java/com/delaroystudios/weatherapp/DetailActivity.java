...
import com.delaroystudios.weatherapp.data.WeatherContract;
import com.delaroystudios.weatherapp.utilities.WeatherDateUtils;
import com.delaroystudios.weatherapp.utilities.WeatherUtils;
...
public class DetailActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.delaroystudios.weatherapp.R.layout.activity_detail);

        mDateView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.date);
        mDescriptionView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.weather_description);
        mHighTemperatureView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.high_temperature);
        mLowTemperatureView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.low_temperature);
        mHumidityView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.humidity);
        mWindView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.wind);
        mPressureView = (TextView) findViewById(com.delaroystudios.weatherapp.R.id.pressure);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.delaroystudios.weatherapp.R.menu.forecast, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.delaroystudios.weatherapp.R.id.action_settings) {
            startActivity(new Intent(this, SettingsActivity.class));
            return true;
        }

        /* Share menu item clicked */
        if (id == com.delaroystudios.weatherapp.R.id.action_share) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String humidityString = getString(com.delaroystudios.weatherapp.R.string.format_humidity, humidity);
         ...
         * pressure.
         */
        String pressureString = getString(com.delaroystudios.weatherapp.R.string.format_pressure, pressure);
