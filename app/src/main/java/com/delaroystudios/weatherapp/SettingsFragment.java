...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        addPreferencesFromResource(com.delaroystudios.weatherapp.R.xml.pref_general);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(com.delaroystudios.weatherapp.R.string.pref_location_key))) {
            // we've changed the location
            // Wipe out any potential PlacePicker latlng values so that we can use this text entry.
            WeatherPreferences.resetLocationCoordinates(activity);
            WeatherSyncUtils.startImmediateSync(activity);
        } else if (key.equals(getString(com.delaroystudios.weatherapp.R.string.pref_units_key))) {
