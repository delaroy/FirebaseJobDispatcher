...
/**
 * This class serves as the ContentProvider for all of WeatherApp's data. This class allows us to
...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In WeatherApp, we use CODE_WEATHER or CODE_WEATHER_WITH_DATE.
         */
    ...
    /**
     * Handles requests to insert a set of new rows. In WeatherApp, we are only going to be
    ...
    /**
     * Handles query requests from clients. We will use this method in WeatherApp to query for all
    ...
    /**
     * In WeatherApp, we aren't going to do anything with this method. However, we are required to
     ...
     *
     * @param uri the URI to query.
     * @return nothing in WeatherApp, but normally a MIME type string, or null if there is no type.
     */
    @Override
     ...
     * @return nothing in WeatherAppv, but normally the URI for the newly inserted item.
     */
    @Override
